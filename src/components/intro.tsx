  ...
  return (
    <Card className="w-full mt-8 max-w-2xl mx-auto p-4 relative overflow-visible">
      <CardHeader className="p-4 relative">
        {/* Header text */}
        <div>
          <CardTitle className="text-2xl mb-0">
            {Profile.name.toUpperCase()}
          </CardTitle>
          <CardDescription className="text-sm mb-0 font-mono">
            {Profile.title.toUpperCase()}
          </CardDescription>
        </div>

        {/* Avatar positioned absolutely */}
        <Avatar className="hidden md:block w-36 h-36 absolute top-0 right-4 -translate-y-1/4 border-4">
